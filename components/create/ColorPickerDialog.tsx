  ...
  return (
    <Dialog onOpenChange={setIsOpen} open={isOpen}>
      <DialogTrigger asChild>
        {trigger || (
          <Pressable className="mr-3 items-center justify-center rounded-xl border-2 border-border border-dashed p-3">
      ...
      <DialogContent className="max-h-[90%]">
        ...
        <View className="gap-4">
          {/* Palette Name Input */}
          <View>
            <Text className="mb-2 font-medium text-sm">Palette Name</Text>
            <TextInput
          ...
          {/* Preset Colors Grid */}
          <View>
            <Text className="mb-2 font-medium text-sm">Preset Colors</Text>
          ...
          {/* Custom Color Input */}
          <View>
            <Text className="mb-2 font-medium text-sm">Custom Hex Color</Text>
